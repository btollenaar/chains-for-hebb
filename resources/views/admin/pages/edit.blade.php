...
@section('content')
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-1">Update content for "{{ $page->title }}"</p>
    </div>
                ...
                <form action="{{ route('admin.pages.update', $page) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="content" id="content-editor" rows="15"
                                  class="w-full border-gray-300 focus:border-admin-teal focus:ring-admin-teal rounded-md shadow-sm">{{ old('content', $page->content) }}</textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3"
                                  class="w-full border-gray-300 focus:border-admin-teal focus:ring-admin-teal rounded-md shadow-sm">{{ old('excerpt', $page->excerpt) }}</textarea>
                    ...
                    <div class="mb-6">
                        ...
                        @if($page->featured_image)
                            <div class="mb-3 flex items-center gap-4">
                                ...
                                <span class="text-sm text-gray-500">Current featured image</span>
                            </div>
                        @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <select name="template" id="template"
                                ...
                                <option value="course-plan" {{ old('template', $page->template) === 'course-plan' ? 'selected' : '' }}>Course Plan</option>
                                <option value="how-to-help" {{ old('template', $page->template) === 'how-to-help' ? 'selected' : '' }}>How to Help</option>
                            </select>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="meta_description" id="meta_description" rows="2" maxlength="160"
                                          class="w-full border-gray-300 focus:border-admin-teal focus:ring-admin-teal rounded-md shadow-sm">{{ old('meta_description', $page->meta_description) }}</textarea>
