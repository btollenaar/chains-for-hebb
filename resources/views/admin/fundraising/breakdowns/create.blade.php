...
@section('content')
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Add Budget Item</h1>
        <p class="text-gray-600 mt-1">Create a new budget breakdown entry</p>
    </div>

    <div class="pb-12">
        <div class="max-w-3xl mx-auto">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <form action="{{ route('admin.fundraising.breakdowns.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm text-gray-500" id="color-hex">{{ old('color', '#6B7280') }}</span>
                            </div>
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" class="btn-admin-primary">
                            <i class="fas fa-save mr-2"></i>Create Budget Item
                        </button>
                    </div>
                </form>
            </div>
